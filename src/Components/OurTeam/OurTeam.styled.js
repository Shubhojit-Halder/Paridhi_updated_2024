...
export const TeamStyles = createGlobalStyle`
  ...
  * {
  ...
  ::-webkit-scrollbar-thumb {
    background: red; /* Color of the scrollbar handle (changed to red) */
    border-radius: 4px; /* Radius of the scrollbar handle */
  }

  /* Handle on hover */
  ::-webkit-scrollbar-thumb:hover {
    background: #ff3333; /* Color of the scrollbar handle on hover (lighter shade of red) */
  }

  /* Adjust scrollbar width for smaller screens */
  @media (max-width: 768px) {
    ::-webkit-scrollbar {
      width: 2px; /* Adjusted width for smaller screens */
    }
  }
